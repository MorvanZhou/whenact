...
class ContextTest(unittest.TestCase):
    ...
    def test_no_ctx(self):
        ...
        self.assertEqual('b0', hist.summary[0].behavior_name)
        self.assertEqual('nw', hist.summary[0].behavior_summary[0].function_name)
        self.assertEqual(True, hist.summary[0].behavior_summary[0].output)
        self.assertEqual(21, hist.summary[0].behavior_summary[1].output)
        self.assertEqual(22, hist.summary[0].behavior_summary[2].output)
